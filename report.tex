...
\begin{document}
    ...
    \begin{itemize}
        \item pour la racine / : on vérifie que la requête renvoit un code de réponse 200 et que le JSON renvoyé contient bien un message à l'attention de l'utilisateur
        \item pour /predict : on vérifie que :
        \begin{itemize}
            \item si on n'envoit pas de token valide avec la requête, aucune prédiction n'est réalisée
